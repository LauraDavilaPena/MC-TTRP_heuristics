...
CW_algorithm_random<-function(string, option, n_trucks, n_trailers, verbose){
  ...
  if (option == 'TTRP') {
    ...
    result<- CW_MCTTRPcore_random(matriz.demandas,matriz.distancia,capacidad.truck,capacidad.trailer,
